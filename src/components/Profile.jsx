  ...
  return (
    <div className="content">
      ...
      <p className="mb-1">
        ...
        私は現在、大学院で生命科学の研究を行っていますが、IT業界でエンジニアとしてキャリアを作りたいと考え就職活動を行っています。
        </p><p className="mb-1">
        大学学部時代、独学でグラフィックデザインやフロントエンド技術を習得し、WebサイトやWebゲームの個人開発を行ってきました。
        新しい知識や技術を学び、自ら手を動かしてつくったものが動くことが私の喜びです。さらに、それで人に喜んでもらえたり役に立ったりしたら、さらに嬉しく思います。
        </p><p className="mb-1">
       また、小学生のころから12年間、フルートやユーフォニアムの演奏を続けてきました。私にとって、楽器演奏を通じた自己表現は何事にも代えがたいものです。
       より良い演奏・表現を目指す試行錯誤の経験は、私の物事に対する取り組み方の根幹になっています。
       </p><p className="mb-8">
